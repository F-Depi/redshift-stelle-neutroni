...
dove $T$ è la temperatura della stella e $h$ la costante di Plank. Considerando solo il caso con $K_B T = 1 \unit{\mega\electronvolt}$ e mettendo l'equzione \ref{eq:rad} in funzione di variabili adimensionali otteniamo
...
\begin{equation}
    ...
    \quad
    A = \frac{2 h \nu_0^3}{c^2} = \frac{2 \unit{\mega\electronvolt}}{(h c)^2} \simeq \num{1.613108e3} \frac{\unit{\mega\electronvolt}}{\unit{\femto\meter\squared}}
\end{equation}
...
\begin{equation}
    ...
    \implies
    \quad
    B(\hat \nu_\text{ric}, \hat r) = A \frac{\left ( \hat \nu_\text{ric} \left ( \frac{1 - \frac{2 \hat M}{\hat r}}{1 - \frac{2 \hat M}{\hat R}}\right )^{1/2} \right ) ^3 }{\exp({\hat \nu_\text{ric} \left ( \frac{1 - \frac{2 \hat M}{r}}{1 - \frac{2 \hat M}{\hat R}}\right )^{1/2}}) - 1}
\end{equation}
...
\begin{figure}[h]
    \begin{minipage}{0.49\textwidth}
        ...
        \caption{Radianza da una stella con $M = 14M_\odot$ e $R = 59\unit{\kilo\meter}$. Essendo la stella con massa maggiore è anche quella in cui il redshift è più visibile.}
        \label{fig:rad1}
    \end{minipage}
    ...
    \begin{minipage}{0.49\textwidth}
        ...
        \caption{Radianza da una stella con $M = 1.5M_\odot$ e $R = 8.6\unit{\kilo\meter}$. In blu la radianza senza correzioni relativistiche.\\}
        \label{fig:rad2}
    \end{minipage}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width = 0.5 \textwidth]{Figures/radianza2.eps}
    \caption{Radianza da una stella con $M = 0.93M_\odot$ e $R = 11\unit{\kilo\meter}$. In blu la radianza senza correzioni relativistiche.}
    \label{fig:rad3}
\end{figure}
